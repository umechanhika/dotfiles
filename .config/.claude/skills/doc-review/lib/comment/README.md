...
| `comment.09-diffview.js` | 差分モードの描画とモード切替。`/baseline` 取得、色分けDOM構築、上部バーの切替ボタン配線（fetchBaseline/toggleDiffMode/renderDiffView/appendReplaceDiffBlock/appendTableRowDiffBlock/appendListItemDiffBlock/updateDiffToggleUI） |
