...
description: 事業側・デザイナーから渡された仕様書・要件書・Figmaデザインを、開発観点でパターン網羅性と仕様漏れの観点から構造的にレビューし、発見した漏れをPdM観点で顧客体験向上の提案に変換する。仕様書・要件書・Figmaデザインの抜け漏れ（未定義の状態・分岐）の洗い出しや、それを基にしたCX観点の提案を求められたら必ず使うこと。仕様書・要件書・FigmaのURLが渡されたら積極的にこのスキルの使用を検討する。
---
